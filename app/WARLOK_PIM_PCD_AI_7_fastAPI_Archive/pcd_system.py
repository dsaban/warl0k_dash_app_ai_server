...
if __name__ == "__main__":
    ...
    audit("info", "SYSTEM", "STARTUP",
          "PCD system starting on http://localhost:7708")
    ...
    print("╠══════════════════════════════════════════════════════════╣")
    print(f"║  UI:         http://localhost:7708                       ║")
    print(f"║  API docs:   http://localhost:7708/docs                  ║")
    print(f"║  Data store: {str(DATA_FILE):<42s}║")
    print(f"║  Audit log:  {str(AUDIT_FILE):<42s}║")
    print(f"║  Archive:    {arc_path:<42s}║")
    print("╚══════════════════════════════════════════════════════════╝")

    uvicorn.run(app, host="0.0.0.0", port=7708, log_level="warning")
# #!/usr/bin/env python3
# """
# ╔══════════════════════════════════════════════════════════════════════════╗
# ║  PCD — PROOF CHAIN OF DATA                                               ║
...
#     AUDIT_FILE.touch(exist_ok=True)
#     audit("info", "SYSTEM", "STARTUP",
#           "PCD system starting on http://localhost:7707")
#     audit("info", "SYSTEM", "PATHS",
#           f"data={DATA_FILE} audit={AUDIT_FILE}")
#
#     arc_path = str(BASE_DIR / "pcd_archive.json")
...
#     print("║  FastAPI + uvicorn + Archive (Epoch HSM + Data Record)   ║")
#     print("╠══════════════════════════════════════════════════════════╣")
#     print(f"║  UI:         http://localhost:7707                       ║")
#     print(f"║  API docs:   http://localhost:7707/docs                  ║")
#     print(f"║  Data store: {str(DATA_FILE):<42s}║")
#     print(f"║  Audit log:  {str(AUDIT_FILE):<42s}║")
#     print(f"║  Archive:    {arc_path:<42s}║")
#     print("╚══════════════════════════════════════════════════════════╝")
#
#     uvicorn.run(app, host="0.0.0.0", port=7707, log_level="warning")
