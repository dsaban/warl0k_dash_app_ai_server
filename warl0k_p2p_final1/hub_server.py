...
REGISTRY = {}  # device_id -> seed0 (NEVER leaves hub)
    ...
    try:
        while True:
            ...
            if cmd == "enroll":
                dev = req["device_id"]
                seed0 = enroll(dev)
                # demo only: returning seed0 just for visibility (remove in prod)
